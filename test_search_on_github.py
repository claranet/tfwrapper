...
def test_search_on_github_terraform_releases(
    ...
    requests_mock.get(releases_url, text=terraform_releases_html)
    requests_mock.get(
        releases_url_after_v0_12_10, text=terraform_releases_html_after_v0_12_10
    )
    requests_mock.get(
        releases_url_after_v0_12_0, text=terraform_releases_html_after_v0_12_0
    )

    assert terraform_releases_html == requests.get(releases_url).text
    assert (
        terraform_releases_html_after_v0_12_10
...
def test_search_on_github_provider_releases(
    requests_mock, provider_releases_html, provider_releases_html_after_v1_3_0
):
    ...
    requests_mock.get(releases_url, text=provider_releases_html)
    requests_mock.get(
        releases_url_after_v1_3_0, text=provider_releases_html_after_v1_3_0
    )

    assert provider_releases_html == requests.get(releases_url).text
