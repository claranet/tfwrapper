...
def test_bootstrap_from_root_unknown_stack(tmp_working_dir_empty_conf, default_args, caplog):
...
def test_bootstrap_from_root_without_stack_config_nor_stack_directory_nor_state_config_nor_template(
    tmp_working_dir_empty_conf, default_args, caplog
):
    with pytest.raises(SystemExit) as e:
        tfwrapper.main(
            [
...
def test_bootstrap_from_root_with_stack_config_but_no_stack_directory_nor_state_config_nor_template(
    tmp_working_dir_empty_conf, default_args, caplog
):
...
def test_bootstrap_from_root_with_stack_config_and_template_but_no_state_config_nor_stack_directory(
    tmp_working_dir_empty_conf, default_args, caplog
):
    paths = tmp_working_dir_empty_conf
    stack_conf = paths["conf_dir"] / "testaccount_testenvironment_testregion_teststack.yml"
...
def test_bootstrap_from_root_with_stack_config_and_state_config_and_template_but_no_stack_directory(
    tmp_working_dir_empty_conf, default_args, caplog
):
    paths = tmp_working_dir_empty_conf
...
def test_bootstrap_from_root_with_stack_config_and_state_config_and_empty_stack_directory_and_template(
...
def test_bootstrap_from_root_with_stack_config_and_non_empty_stack_directory_and_template_but_no_stack_tf(
    tmp_working_dir_regional, default_args, caplog
):
    paths = tmp_working_dir_regional
    state_conf = paths["conf_dir"] / "state.yml"
